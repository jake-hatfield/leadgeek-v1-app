...
const Alert: React.FC = () => {
	...
	return (
		<animated.div
			...
			className={`fixed bottom-0 left-1/2 z-40 w-full max-w-4xl py-4 px-6 rounded-main shadow-lg bg-gray-900 dark:bg-darkGray-200 border border-gray-700 dark:border-darkGray-100`}
		>
