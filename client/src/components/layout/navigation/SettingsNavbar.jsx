...
const NavbarLink = ({ link }) => {
	...
	return (
		<div v-for='item in items'>
			...
			>
				{hover && (
					<div className='w-auto max-w-xs mt-2 ml-2 p-2 absolute left-0 z-40 transform -translate-y-1 translate-x-48 rounded-lg bg-gray-900 shadow-md text-white text-sm whitespace-no-wrap'>
						{link.desc}
					</div>
				)}
...
const SettingsNavbar = () => {
	...
	return (
		<nav className='fixed top-0 left-15 z-0 h-full min-h-screen w-48 pt-8 pb-16 flex flex-col justify-between bg-gray-100 text-gray-600 border-r border-gray-400'>
			<aside>
