...
const ExportButton = ({ user, leads, setExportLeads }) => {
	...
	return (
		<CSVLink
			...
			target='_blank'
			className='ml-4 py-2 px-3 flex items-center rounded-lg bg-purple-500 text-white shadow-sm hover:shadow-md text-sm font-semibold hover:bg-purple-600 transition duration-100 ease-in-out focus:outline-none focus:shadow-outline'
		>
			<span>
				<svg
